                ...
                <div className="p-4">
                  ...
                  <div className="mt-3 flex gap-2">
                    <button
                      ...
                      className="flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-[var(--brand-600)] px-3 py-2 text-xs font-semibold text-white transition-colors hover:bg-[var(--brand-700)] disabled:opacity-50 disabled:cursor-not-allowed"
                    >
